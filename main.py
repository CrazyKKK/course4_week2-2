...
K.set_learning_phase(1) #1为训练模式，0为工作模式
...
def ResNet50(input_shape = (64,64,3),classes = 6):
    """
       ...
       """
    # Define the input as a tensor with shape input_shap
...
print ("MyLoss = " + str(preds[0]))
print ("MyTest Accuracy = " + str(preds[1]))
"""
model = load_model('ResNet50.h5')
preds = model.evaluate(X_test, Y_test)
print ("NgLoss = " + str(preds[0]))
print ("NgTest Accuracy = " + str(preds[1]))
"""
